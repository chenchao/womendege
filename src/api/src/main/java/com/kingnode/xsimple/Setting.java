...
//    public static final int cookieTime=1*30*24*3600;
    ...
    public static final String FUNUNZIP =  "/unzip";
    ...
    public static final Long messageTime = 1000*3600*24*2L;//推送列表获取2天内的数据,add by cici 20150403
    ...
    public enum MessageType{
        systemmes("系统消息"),intermes("接口推送消息"),
        clearuser("清除用户"),cleardevice("清除设备"),
        onlineupdate("在线更新"),receiptmes("消息回执");//receiptmes 20150403add by cici
        private final String m_type;
