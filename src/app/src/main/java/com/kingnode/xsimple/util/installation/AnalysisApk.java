...
import com.kingnode.xsimple.util.installation.support.res.AXmlResourceParser;
import com.kingnode.xsimple.util.installation.support.res.XmlPullParser;
import com.kingnode.xsimple.util.installation.support.util.TypedValue;
/**
 * 分析APK文件，取得APK文件中的 包名、版本号及图标。
 * 依赖的jar包：AXMLPrinter2.jar
 */
        ...
        try{
            ...
            while(enumeration.hasMoreElements()){
                ...
                if(zipEntry.isDirectory()){
                    ...
                    if(APKMAINFILE.equalsIgnoreCase(zipEntry.getName())){
                        try{
