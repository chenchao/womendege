    ...
    <div class="col-md-12">
        <div class="portlet box green-haze">
            <div class="portlet-title">
                <div class="caption"><i class="fa fa-cogs"></i>OA用户导入列表</div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-12">
                                <form action="" enctype="multipart/form-data" class="form-horizontal" id="myForm" type="post">
                                    <input type="hidden" name="importType" value="5"/>
								...
								<span>
									 保存上传
                                        ...
                                        <button type="button" class="btn blue start" onclick="downLoadExcel(5)">
                                            <i class="fa fa-long-arrow-down"></i>
								<span>
									 下载模板
								</span>
            ...
            var oTable=$('#import_user_data_table').dataTable({
                ...
                "aoColumns":[
                    ...
                    { "sTitle":"来自系统","mData":"fromSystem","sDefaultContent":"","mRender":function(data,type,full){
                        return "<input class='form-control input-small' name='fromSystem' type='text' value="+full[0].fromSystem+">";
                    }},
                    { "sTitle":"角色名称","mData":"roleName","sDefaultContent":"","mRender":function(data,type,full){
                        return "<input style='width:350px;' class='form-control input-small' name='roleName' type='text' value="+full[1].roleList[0].name+">";
                    }},
