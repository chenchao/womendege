...
<div class="row">
    <div class="col-md-4" style="width:300px;overflow:auto;">
                        ...
                        <div class="actions">
                            <div class="btn-group">
                                <a class="btn green btn-parent">
                                    ...
                                    <span class="hidden-480">新增父资源</span>
                                </a>
                                <button type="button" class="btn green btn-children " disabled="disabled">
                                    <i class="fa fa-plus"></i>
                                    <span class="hidden-480">新增子资源</span>
                                </button>
                                <button type="button" class="btn blue btn-edit" disabled="disabled">
                                    <i class="fa fa-edit"></i>
                                    <span class="hidden-480">编辑此资源</span>
                                </button>
                                <button type="button" class="btn red btn-delete" disabled="disabled">
                                    <i class="fa fa-trash-o"></i>
                                    <span class="hidden-480">删除此资源</span>
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="portlet-body form">
                        <form id="resourceForm" action="${rc.contextPath}/system/resource/save" class="form-horizontal form-bordered" method="POST">
...
<content tag="script">
    ...
    <script type="text/javascript">
        ...
        $("#resTree").jstree({
            ...
            if(rid){
                $.ajax({
                    url:'${rc.contextPath}/system/resource/read/'+rid,
                    type:'GET',
        ...
        $('.btn-delete').click(function(){
            if(rid)
                if(confirm("确认要删除此资源及其下级所有资源吗？"))
                    $.ajax({
                        url:'${rc.contextPath}/system/resource/delete/'+rid,
                        type:'DELETE',
                        success:function(){
...
var queryByPage=function(){
    ...
    $.ajax({
        ...
        cache:true,
        type:"GET",
        url:"${rc.contextPath}/assets/global/icon.json",
        traditional:true,
        success:function(data){
