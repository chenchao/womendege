...
@Controller @RequestMapping(value="/product/detail") public class ProductDetailController{
    ...
    @RequestMapping(value="create-detail", method=RequestMethod.GET) public String createDetailForm(Model model){
        model.addAttribute("action","create");
     ...
     * 进入编辑子集页面
     */
    @RequestMapping(value="sub-view") public String subViewForm(Model model){
